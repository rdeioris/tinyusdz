...
bool ReconstructPrim<DistantLight>(
  ...
  for (const auto &prop : properties) {
    ...
    PARSE_TYPED_ATTRIBUTE(table, prop, "inputs:shaping:focus", DistantLight, light->shapingFocus)
    PARSE_TYPED_ATTRIBUTE(table, prop, "inputs:shaping:focusTint", DistantLight, light->shapingFocusTint)
    PARSE_TYPED_ATTRIBUTE(table, prop, "inputs:shaping:cone:angle", DistantLight, light->shapingConeAngle)
    PARSE_TYPED_ATTRIBUTE(table, prop, "inputs:shaping:cone:softness", DistantLight, light->shapingConeSoftness)
...
bool ReconstructPrim<DomeLight>(
  ...
  for (const auto &prop : properties) {
    ...
    PARSE_TYPED_ATTRIBUTE(table, prop, "inputs:shaping:focus", DomeLight, light->shapingFocus)
    PARSE_TYPED_ATTRIBUTE(table, prop, "inputs:shaping:focusTint", DomeLight, light->shapingFocusTint)
    PARSE_TYPED_ATTRIBUTE(table, prop, "inputs:shaping:cone:angle", DomeLight, light->shapingConeAngle)
    PARSE_TYPED_ATTRIBUTE(table, prop, "inputs:shaping:cone:softness", DomeLight, light->shapingConeSoftness)
